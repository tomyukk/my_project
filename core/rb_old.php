...
//Для того, чтобы это все заработало, нужно прописать: $adapter = R::getDatabaseAdapter(); $adapter->addEventListener('sql_exec', new \RedBeanPHP\CheckiantLogger);
//Мы это сделали в ConnectDB.
//По-хорошему этот класс нужно вытащить в отдельный файл.
class CheckiantLogger implements \RedBeanPHP\Observer {
